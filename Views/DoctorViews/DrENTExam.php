			...
			<div class="services__container">
				...
				<div class="services__content">
					...
					<form class="services__content--form">
						...
						<!-- Khám tai -->
						<div class="services__content--sub__title">Khám tai</div>
						<div class="form__item">
							<div class="form__item--group">
								<label for="">Tai ngoài:</label>
								<input type="text" required class="form__item--input">
							</div>

							<div class="form__item--group">
								<label for="">Ống tai:</label>
								<input type="text" required class="form__item--input">
							</div>

							<div class="form__item--group">
								<label for="">Màng nhĩ:</label>
								<input type="text" required class="form__item--input">
							</div>
						</div>

						<!-- Khám mũi -->
						<div class="services__content--sub__title">Khám mũi</div>
						<div class="form__item">
							<div class="form__item--group">
								<label for="">Niêm mạc mũi:</label>
								<input type="text" required class="form__item--input">
							</div>

							<div class="form__item--group">
								<label for="">Dịch mũi:</label>
								<input type="text" required class="form__item--input">
							</div>

							<div class="form__item--group">
								<label for="">Vách ngăn:</label>
								<input type="text" required class="form__item--input">
							</div>
						</div>

						<!-- Khám họng -->
						<div class="services__content--sub__title">Khám họng</div>
						<div class="form__item">
							<div class="form__item--group">
								<label for="">Niêm mạc họng:</label>
								<input type="text" required class="form__item--input">
							</div>

							<div class="form__item--group">
								<label for="">Amidan:</label>
								<input type="text" required class="form__item--input">
							</div>

							<div class="form__item--group">
								<label for="">Hạch cổ:</label>
								<input type="text" required class="form__item--input">
							</div>
						</div>
